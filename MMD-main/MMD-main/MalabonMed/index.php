        ...
        <div class="container-md">
            ...
            <div class="carousel radius-5 container-fluid p-5 bg-warning rounded-5 shadow mb-5">
                <div class="container-md" id="home">
                    ...
                    <button type="button" class="btn btn1 btn-info shadow ">Reserve Now
                            ...
                            <div class="container text-center pt-5">
                                <div class="row">
                                    ...
                                    <div class="col p-5 bg-danger bg-opacity-25 shadow  rounded-2 m-2">
                                        ...
                                        Allow users to cancel/reschedule the appointment
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col p-5 bg-warning bg-opacity-50 shadow  rounded-2 m-2">
                                        ...
                                        <b>Reminder Notification</b><br>
                                        Reminders for upcoming appointments. These can be sent via email or SMS.
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-md ">
                ...
                <p class="text-center py-5">
                    <a class="icon-link icon-link-hover" href="#">See More
        ...
        <div class="container-md ">
            <div class="about container-md py-5">
                ...
                <div class="text-center py-5">
                    <a class="icon-link1 icon-link icon-link-hover " href="#">See More
